  ...
  <div class="content">
    <div class="post">
      ...
      <div class="likeandretweet">
        <svg v-if="!like" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" @click="$emit('like', $event)">
        ...
        <svg v-else-if="like" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" @click="handleAction">
          <path fill="none" d="M0 0H24V24H0z" />
          <path
